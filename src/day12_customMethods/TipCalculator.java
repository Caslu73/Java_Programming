...
public class TipCalculator {
    ...
    public static void main(String[] args) {
        ...
        String yesNo= input.next().toLowerCase(); //if the user input like "YES" TO convert to ==> yes
        ...
        String service = input.next().toLowerCase(); // convert to lower case
        ...
        double totalTip= (service.equals("excellent"))? amount * 0.25
                ...
                :(service.equals("fair"))? amount * 0.10 : amount * 0.5;
