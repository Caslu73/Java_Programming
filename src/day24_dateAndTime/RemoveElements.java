...
public class RemoveElements {
    ...
    public static void main(String[] args) {
        ...
        list2.removeIf( p -> p < 4); // remove elements that are less than 4

        System.out.println(list2);

        System.out.println("------------------------------------------------------");
            //REMOVE ELEMENTS THAT STARTS WITH J
        ArrayList<String> names = new ArrayList<>();
        names.addAll(Arrays.asList("Java", "Python", "C#", "Java", "Ruby"));


        //loop of the removeIf method
        names.removeIf( p -> p.startsWith("J") );//"p" is just a variable for each element

        System.out.println(names);

        System.out.println("---------------------------------------------------------------");
            //REMOVE EMPLOYEES WITH SALARY LESS THAN 100000
      ...
      //for each loop to print the names of the employees
