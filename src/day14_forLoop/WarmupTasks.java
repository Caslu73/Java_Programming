...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
        ...
        String s3 = " " + false;//" false" it will print with space
        // space
    ...
    public static String combine(String str1, String str2) {
        ...
        String result;
           /*                    //Char I can convert it to a string by concatenating by adding double quote/empty space
        ...
        if(str1.charAt(str1.length()-1)==str2.charAt(0)) {// if the last character of the first string is equal to the
    ...
    public static int sumOf4IntegerNumbers(int n1, int n2, int n3, int n4){
        //return sumOf3IntegerNumbers(n1,n2,n3) + n4; VALID WAY
        return sumOf2IntegerNumbers(n1,n2) + sumOf2IntegerNumbers(n3,n4); // Valid
...
Warmup Tasks:
	Task1:
	    Create a method named combine that can take two string and hen add them together and returns it.
        	But if the last letter of the first word and the first letter of the last letter are the same, return
        	that character once.
