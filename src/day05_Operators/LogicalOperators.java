...
public class LogicalOperators {
    ...
    public static void main(String[] args) {
        ...
        //Logical "&&" AND Whenever there is a FALSE expression the result will be always FALSE
        // && both
        ...
        /*
         Logical OR Operator, IF ONE expression is True always will get a True result, IF BOTH ARE FALSE than it will
         be False. || either
         */
