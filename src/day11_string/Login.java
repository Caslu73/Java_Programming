...
public class Login {
    ...
    public static void main(String[] args) {
        ...
        String correctUsername = "Cydeo"; //literal , this is inside the pool
        String correctPassword = "WoodenSpoon"; // literal

        Scanner input = new Scanner(System.in);

        System.out.println("Enter your username");
        String username = input.nextLine(); // new , this is outside the pool
