...
public class WarmupTasks {
    ...
    public static void main(String[] args) { // Methods can be created inside the class, but it has to be outside any other blocks or methods
...
*/
    ...
    public static void ageGroup(int age){
        ...
        if(age >=0 && age <= 150){ // Pre condition
...
Warmup task:
	1. Create a method named calculate that can take three arguments:
	    ...
	    The method should display the calculation result of those two numbers as long as the
	    3rd argument is a valid math operator, otherwise the method prints "Invalid Operator"
