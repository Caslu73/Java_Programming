package day34_abstraction_continue.carTask;

public  abstract class Car {

    private final String make, model;// final means can initialize only one time
    ...
    protected final void stop(){//protected to make sure that non-subclasses outside the package can not access it
