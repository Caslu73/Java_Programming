...
public class TestObjects {
    ...
    public static void main(String[] args) {
        ...
        group1.addStudent(student1); //student object
        group1.addStudent(students); // real student
        ...
        for (Student each : group1.students) {//print all the information of the students
...
3. Create a class named TestObjects
	            ...
	            3.3 Add all the student objets to the StudentsGroup object's students list
 */
