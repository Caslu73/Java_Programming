...
public class GradeLevel {
    ...
    public static void main(String[] args) {
        ...
        if (gradeLevel <= 5) {                     // false when gradeLevel is >=6
            result = "Elementary school";

        } else if (gradeLevel <= 8) {            // false when gradeLevel is >=9
            result = "Middle school";

        } else if (gradeLevel <= 12) {          // false when gradeLevel is >=13
            result = "High school";

        } else if (gradeLevel <= 16) {         //  false when gradeLevel is >=17
            result = "College";
