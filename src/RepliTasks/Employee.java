...
public class Employee {
    ...
    public static void main(String[] args) {
        ...
        String name = "Noah", lastName = "Smith", companyName = "Apple", jobTitle = "SDET", officeAddress ="One Apple Park Way, Cupertino, CA 95014 " ;
        String startDay = "10", startMonth = "1", startYear = "2022";
        ...
        String  email = name + startDay +"@"+companyName+".com";

        double salaryAfter2years = (salary*15) ;

        System.out.println("Employee Information");
        System.out.println("We have "+fullName+ " joining "+companyName);
        System.out.println(name+ " will start on " + fullStartDay+ " as full time: "+isFullTime);
        System.out.println(name+ " here is some information about your employment");
        System.out.println("Your email is "+ email);
        System.out.println("Your base salary is $"+ salary+ " and after two years it will be $"+salaryAfter2years);
